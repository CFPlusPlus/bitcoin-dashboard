      ...
      >
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
          ...
          <MetricCard
            ...
            value={formatPercent(onChainActivity?.activeAddresses.change7dPercent ?? null, locale)}
          ...
          <MetricCard
            ...
            value={formatPercent(onChainActivity?.transactionCount.change7dPercent ?? null, locale)}
