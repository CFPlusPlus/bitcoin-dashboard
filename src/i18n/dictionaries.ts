  ...
  de: {
    ...
    dashboard: {
      ...
      overview: {
        ...
        highMeta: "Hoechster Preis der letzten 24 Stunden.",
      ...
      chart: {
        ...
        description: "So hat sich der BTC-Preis fuer {range} bewegt.",
        chooseRange: "Zeitraum waehlen",
        chooseRangeAriaLabel: "Chart-Zeitraum waehlen",
        ...
        contextLine: "Bitcoin in {currency} ueber die {range}",
        ...
        latest: "Zuletzt",
        direction:
          "Leserichtung: links aelter, rechts aktueller. Der markierte Punkt zeigt den letzten Kurs im gewaehlten Bereich.",
        timeWindow: "Zeitfenster: {start} bis {end}",
        ariaLabel: "Bitcoin-Preischart fuer {days} Tage in {currency}",
        axisContext:
          "Achsenkontext: unten Zeit, links Preisniveau. Die Skala passt sich automatisch an den gewaehlten Zeitraum an.",
      ...
      marketContext: {
        ...
        description: "Zwei Zahlen, die zeigen, wie gross und aktiv der Markt gerade ist.",
        marketCapLabel: "Marktkapitalisierung ({currency})",
        marketCapMeta: "Wert aller umlaufenden BTC.",
        marketCapFootnote: "Zeigt die Groesse des Bitcoin-Markts.",
        volumeLabel: "24h Volumen ({currency})",
        volumeMeta: "Geschaetztes Handelsvolumen der letzten 24 Stunden.",
        volumeFootnote: "Mehr Volumen heisst meist mehr echte Marktaktivitaet.",
      },
      network: {
        eyebrow: "Netzwerk",
        ...
        latestBlockMeta: "Zuletzt gesehene Blockhoehe.",
        latestBlockFootnote: "Steigt fortlaufend, wenn das Netzwerk sauber weiterlaeuft.",
        fastestFee: "Prioritaets-Fee",
        fastestFeeMeta: "Fee fuer schnelle Bestaetigung.",
        fastestFeeFootnote: "Sinnvoll, wenn es moeglichst bald durchgehen soll.",
        halfHourFee: "Fee in ca. 30 Minuten",
        halfHourFeeMeta: "Fee mit etwas Zeitpuffer.",
        halfHourFeeFootnote: "Gut fuer Zahlungen, die bald ankommen sollen.",
      ...
      sentiment: {
        eyebrow: "Sentiment",
        title: "Marktstimmung",
        description: "Fear & Greed zeigt, ob der Markt gerade eher nervoes oder gierig ist.",
        indexLabel: "Fear & Greed Index",
        indexMeta: "Stimmungsindikator fuer das aktuelle Marktumfeld",
        nextUpdate: "Naechste Aktualisierung",
        nextUpdateHint: "Dann kommt der naechste Stimmungscheck.",
      ...
      metadata: {
        ...
        description:
          "Aktive Waehrung: {currency}. Kompakt, damit Quelle und letzter Stand schnell sichtbar bleiben.",
